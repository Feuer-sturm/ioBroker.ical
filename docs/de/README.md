...
- `ical.0.events.0.today`: Das Event im Pfad ical.0.events.0.today wird auf true gesetzt, wenn das Event am heutigen Tag aktiv ist
...
### Farbe
  - `Farbe`: "white" Farbe des Kalenders, wenn die Option "Jeder Kalender hat eine eigene Farbe" gesetzt ist.
  
### Filter und Filter als regulärer Ausdruck
